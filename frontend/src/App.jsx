              ...
              {["Acasă", "Produse", "Noutăți", "Despre", "Contact"].map(
                (item, i) => (
                  <a
                    ...
                    className="hover:text-[#00C896] transition relative group"
                  >
                    {item}
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#00C896] group-hover:w-full transition-all"></span>
                  </a>
                ),
              )}
            </nav>
